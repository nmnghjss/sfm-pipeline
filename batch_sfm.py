...
if __name__ == '__main__':
    ...
    for dataset_dir in dataset_path:
        ...
        if "sfm" in args.pipeline:
            ...
            sfm_command = "python sfm-colmap-v4.py --clean --feature_type LOMA --loma_variant loma_R --match_strategy threshold --max_matches_per_image 30 --max_feature_num 2048 --mapper acc"
            # sfm_command = "python sfm-colmap-v4.py --clean --feature_type LOMA --loma_variant loma_B128 --match_strategy threshold --max_matches_per_image 30 --max_feature_num 2048 --mapper acc"
