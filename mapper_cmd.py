...
def get_incremental_mapper_cmd(colmap_command: str, 
    ...
    mapper_cmd = [
        ...
        "--Mapper.ba_refine_principal_point", str(refine_principal_point), # 0
        "--Mapper.ba_refine_extra_params", str(refine_extra_params), # 1
        "--Mapper.max_extra_param", "1", # 1
        "--Mapper.ba_use_gpu", str(use_gpu),  # 0
        "--Mapper.ba_local_backend", str(ba_local_backend), # Ceres
        "--Mapper.ba_global_backend", str(ba_global_backend), # Ceres
        ...
        "--Mapper.filter_max_reproj_error", str(filter_max_reproj_error), # 4
        "--Mapper.filter_min_tri_angle", str(filter_min_tri_angle), # 1.5
        "--Mapper.tri_min_angle", "1.5", # 1.5
        "--Mapper.tri_create_max_angle_error", "2", # 2
        "--Mapper.tri_continue_max_angle_error", "2", # 2
        "--Mapper.tri_merge_max_reproj_error", "4", # 4
        "--Mapper.tri_complete_max_reproj_error", "4", # 4
        "--Mapper.tri_complete_max_transitivity", "5", # 5
        "--Mapper.tri_re_max_angle_error", "5", # 5
        "--Mapper.tri_re_min_ratio", "0.2", # 0.2
        "--Mapper.tri_re_max_trials", "1", # 1
...
def get_hierarchical_mapper_cmd(colmap_command: str,
    ...
    mapper_cmd = [
        ...
        "--Mapper.ba_refine_focal_length", str(refine_focal_length),
        "--Mapper.ba_refine_principal_point", str(refine_principal_point),
        "--Mapper.ba_refine_extra_params", str(refine_extra_params),
...
def get_global_mapper_cmd(colmap_command: str, 
                   ...
                   tri_min_angle: int = 1,
                   ra_max_rotation_error_deg: float = 10.0,
                   ra_max_rotation_error_final_deg: float = 10.0,
                   ra_refilt_outlier_paisrs_num: int = 100,
    ...
    mapper_cmd = [
        ...
        "--GlobalMapper.ba_backend", str(ba_backend),
        "--GlobalMapper.ba_ceres_use_gpu", str(use_gpu), # 1
        ...
        "--GlobalMapper.ba_skip_fixed_rotation_stage", "0", # 0
        ...
        "--GlobalMapper.ra_max_rotation_error_final_deg", str(ra_max_rotation_error_final_deg),
        "--GlobalMapper.ra_refilt_outlier_paisrs_num", str(ra_refilt_outlier_paisrs_num),
...
def get_pos_prior_mapper_cmd(colmap_command: str, 
                             log_level: int, 
                             database_path: str, 
                             images_path: str,
                             input_path: str,
...
def get_points_triangulate_cmd(colmap_command: str,
    ...
    triangulate_cmd = [
        ...
        "--Mapper.max_runtime_seconds", "-1",
        "--Mapper.tri_max_transitivity", "1",
        "--Mapper.tri_create_max_angle_error", str(tri_create_max_angle_error), # 2.0
        "--Mapper.tri_continue_max_angle_error", str(tri_continue_max_angle_error), # 2.0
        "--Mapper.tri_merge_max_reproj_error", str(tri_merge_max_reproj_error), # 4
        "--Mapper.tri_complete_max_reproj_error", str(tri_complete_max_reproj_error), # 4
        "--Mapper.tri_complete_max_transitivity", str(tri_complete_max_transitivity), # 5
        "--Mapper.tri_re_max_angle_error", str(tri_re_max_angle_error), # 5
        "--Mapper.tri_re_min_ratio", "0.2",
        "--Mapper.tri_re_max_trials", "1",
        "--Mapper.tri_min_angle", "1.5",
        "--Mapper.tri_ignore_two_view_tracks", "1"
...
def get_reconstruction_refine_cmd(colmap_command: str, 
                   ...
                   max_normalized_reproj_error: float = 0.01,
                   min_tri_angle_deg: float = 1.0,
                   tri_complete_max_reproj_error: float = 15.0,
                   tri_merge_max_reproj_error: float = 15.0,
                   refine_focal_length: int = 1,
                   refine_principal_point: int = 1,
                   refine_extra_params: int = 1                   
                   ):
