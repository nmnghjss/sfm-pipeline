...
class LoMaB128(LoMa.Cfg):
	...
	weights_url: str = (
		...
		"checkpoints/checkpoint/loma_B128.pth"
	)
...
class LoMaB(LoMa.Cfg):
	...
	weights_url: str = (
		...
		"checkpoints/checkpoint/loma_B.pth"
	)
...
class LoMaL(LoMa.Cfg):
	...
	# 	"https://github.com/davnords/storage/releases/download/loma/loma_L.pth"
		"checkpoints/checkpoint/loma_L.pth"
	)
...
class LoMaG(LoMa.Cfg):
	...
	weights_url: str = (
		...
		"checkpoints/checkpoint/loma_G.pth"
	)
...
class LoMaR(LoMa.Cfg):
	...
	weights_url: str = (
		...
		"checkpoints/checkpoint/loma_R.pth"
	)
